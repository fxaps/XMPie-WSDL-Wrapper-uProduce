...
class GetCompatibleTablesByInfoForHosting
{
    ...
    /**
     * @param string $inUsername
     * @return \XMPieWsdlClient\XMPie\uProduce\v_11_2_2\BasicServices\DataSourcePlanUtils_SSP\GetCompatibleTablesByInfoForHosting
     */
