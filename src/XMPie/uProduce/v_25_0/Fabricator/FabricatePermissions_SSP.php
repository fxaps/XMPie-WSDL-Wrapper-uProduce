...
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\IsAllowed;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\IsAllowedResponse;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\SetAllowed;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\SetAllowedResponse;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\Get;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\GetResponse;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\ArrayOfPermission;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\Permission;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\GetView;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\GetViewResponse;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\GetViewResult;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\GetXMPTblDataSet;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\GetXMPTblDataSetResponse;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\XMPTblDataSet;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\ArrayOfXMPTbl;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\XMPTbl;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\ArrayOfXMPTblColumn;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\XMPTblColumn;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\ArrayOfXMPTblRow;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\XMPTblRow;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\ArrayOfXMPRowField;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\XMPRowField;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\SetAllowedList;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\SetAllowedListResponse;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\RemoveOverload;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\RemoveOverloadResponse;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\GetPermittedUsers;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\GetPermittedUsersResponse;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\ArrayOfString;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\GetPermittedUsersView;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\GetPermittedUsersViewResponse;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\GetPermittedUsersViewResult;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\GetPermittedUsersXMPTblDataSet;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\GetPermittedUsersXMPTblDataSetResponse;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\LockResource;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\LockResourceResponse;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\UnLockResource;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\UnLockResourceResponse;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\IsResourceLocked;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\IsResourceLockedResponse;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\IsResourceLockedByAnotherUser;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\IsResourceLockedByAnotherUserResponse;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\IsResourceLockedByCurrentUser;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\IsResourceLockedByCurrentUserResponse;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\GetResourceLockingUserName;
use XMPieWsdlClient\XMPie\uProduce\v_25_0\OtherServices\Permissions_SSP\GetResourceLockingUserNameResponse;
...
class FabricatePermissions_SSP
{
   ...
   /**
    * @param array $paramAutoSet
    * @return IsResourceLockedByAnotherUser
    */
    public function IsResourceLockedByAnotherUser($paramAutoSet = [])
    {
        $paramAutoSet = array_merge($this->paramAutoSet, $paramAutoSet);
        $IsResourceLockedByAnotherUser = new IsResourceLockedByAnotherUser();
        foreach ($paramAutoSet as $paramKey => $paramValue) {
            $methodName = 'set' . $paramKey;
            if (method_exists($IsResourceLockedByAnotherUser, $methodName)) {
                $IsResourceLockedByAnotherUser->$methodName($paramValue);
            }
        }
        return $IsResourceLockedByAnotherUser;
    }
    ...
    */
    public function IsResourceLockedByAnotherUserResponse($paramAutoSet = [])
    {
        $paramAutoSet = array_merge($this->paramAutoSet, $paramAutoSet);
        $IsResourceLockedByAnotherUserResponse = new IsResourceLockedByAnotherUserResponse();
        foreach ($paramAutoSet as $paramKey => $paramValue) {
            $methodName = 'set' . $paramKey;
            if (method_exists($IsResourceLockedByAnotherUserResponse, $methodName)) {
                $IsResourceLockedByAnotherUserResponse->$methodName($paramValue);
            }
        }
        return $IsResourceLockedByAnotherUserResponse;
    }
   ...
   /**
    * @param array $paramAutoSet
    * @return IsResourceLockedByCurrentUser
    */
    public function IsResourceLockedByCurrentUser($paramAutoSet = [])
    {
        $paramAutoSet = array_merge($this->paramAutoSet, $paramAutoSet);
        $IsResourceLockedByCurrentUser = new IsResourceLockedByCurrentUser();
        foreach ($paramAutoSet as $paramKey => $paramValue) {
            $methodName = 'set' . $paramKey;
            if (method_exists($IsResourceLockedByCurrentUser, $methodName)) {
                $IsResourceLockedByCurrentUser->$methodName($paramValue);
            }
        }
        return $IsResourceLockedByCurrentUser;
    }
    ...
    */
    public function IsResourceLockedByCurrentUserResponse($paramAutoSet = [])
    {
        $paramAutoSet = array_merge($this->paramAutoSet, $paramAutoSet);
        $IsResourceLockedByCurrentUserResponse = new IsResourceLockedByCurrentUserResponse();
        foreach ($paramAutoSet as $paramKey => $paramValue) {
            $methodName = 'set' . $paramKey;
            if (method_exists($IsResourceLockedByCurrentUserResponse, $methodName)) {
                $IsResourceLockedByCurrentUserResponse->$methodName($paramValue);
            }
        }
        return $IsResourceLockedByCurrentUserResponse;
    }
