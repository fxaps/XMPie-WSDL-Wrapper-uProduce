...
class ArrayOfXMPRowField implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @return \XMPieWsdlClient\XMPie\uProduce\v_13_2\UndocumentedServices\PlanPartsProvider_SSP\ArrayOfXMPRowField
     */
     ...
     * @return XMPRowField
     */
    public function offsetGet($offset): XMPRowField
    {
     ...
     */
    public function current(): XMPRowField
    {
