...
class SubJobInfo
{
    ...
    /**
     * @param int $m_Index
     * @param int $m_PartCount
     * @param int $m_SplitNum
     * @param int $m_SplitType
     * @param int $m_OrigFrom
     * @param int $m_OrigTo
     */
    public function __construct($m_Index = null, $m_PartCount = null, $m_SplitNum = null, $m_SplitType = null, $m_OrigFrom = null, $m_OrigTo = null)
    {
      $this->m_Index = $m_Index;
      $this->m_PartCount = $m_PartCount;
    ...
    /**
     * @param int $m_Index
     * @return \XMPieWsdlClient\XMPie\uProduce\v_12_0_1\ProductionServices\JobTicket_SSP\SubJobInfo
     */
     ...
     * @return int
     */
    public function getM_PartCount()
    {
     ...
     * @return \XMPieWsdlClient\XMPie\uProduce\v_12_0_1\ProductionServices\JobTicket_SSP\SubJobInfo
     */
    public function setM_PartCount($m_PartCount)
    {
      $this->m_PartCount = $m_PartCount;
      return $this;
    }
