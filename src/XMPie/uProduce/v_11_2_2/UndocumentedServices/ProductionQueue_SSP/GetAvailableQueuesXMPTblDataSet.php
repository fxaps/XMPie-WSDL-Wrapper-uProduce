...
class GetAvailableQueuesXMPTblDataSet
{
    ...
    /**
     * @param string $inUsername
     * @return \XMPieWsdlClient\XMPie\uProduce\v_11_2_2\UndocumentedServices\ProductionQueue_SSP\GetAvailableQueuesXMPTblDataSet
     */
