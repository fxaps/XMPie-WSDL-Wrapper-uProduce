...
class ArrayOfPlanTabularColumn implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @return \XMPieWsdlClient\XMPie\uProduce\v_12_0_1\OtherServices\InteractiveCampaign_SSP\ArrayOfPlanTabularColumn
     */
     ...
     * @return PlanTabularColumn
     */
    public function offsetGet($offset): PlanTabularColumn
    {
     ...
     */
    public function current(): PlanTabularColumn
    {
