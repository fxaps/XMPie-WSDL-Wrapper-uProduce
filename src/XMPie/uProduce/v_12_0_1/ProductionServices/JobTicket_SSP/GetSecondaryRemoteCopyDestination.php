...
class GetSecondaryRemoteCopyDestination
{
    ...
    /**
     * @param string $inUsername
     * @return \XMPieWsdlClient\XMPie\uProduce\v_12_0_1\ProductionServices\JobTicket_SSP\GetSecondaryRemoteCopyDestination
     */
