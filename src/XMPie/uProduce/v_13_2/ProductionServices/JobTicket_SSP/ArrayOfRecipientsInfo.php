...
class ArrayOfRecipientsInfo implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @return \XMPieWsdlClient\XMPie\uProduce\v_13_2\ProductionServices\JobTicket_SSP\ArrayOfRecipientsInfo
     */
     ...
     * @return RecipientsInfo
     */
    public function offsetGet($offset): RecipientsInfo
    {
     ...
     */
    public function current(): RecipientsInfo
    {
