...
class ProductInfo
{
    ...
    /**
     * @var string $m_LicenseKey
     */
    protected $m_LicenseKey = null;

    /**
     * @var string $m_SystemID
     */
    protected $m_SystemID = null;

    /**
     * @var string $m_APIServer
     */
    ...
    /**
     * @param string $m_Name
     * @return \XMPieWsdlClient\XMPie\uProduce\v_11_2_2\UndocumentedServices\SystemManager_SSP\ProductInfo
     */
