...
class RecipientsInfo
{
    ...
    /**
     * @var boolean $m_SortByPrimaryField
     */
    protected $m_SortByPrimaryField = null;
     ...
     * @param boolean $m_SortByPrimaryField
     * @param int $m_recipientIDListMergeType
     */
    public function __construct($m_From = null, $m_To = null, $m_FilterType = null, $m_SortByPrimaryField = null, $m_recipientIDListMergeType = null)
    {
      $this->m_From = $m_From;
      $this->m_To = $m_To;
      $this->m_FilterType = $m_FilterType;
      $this->m_SortByPrimaryField = $m_SortByPrimaryField;
    ...
    /**
     * @param int $m_From
     * @return \XMPieWsdlClient\XMPie\uProduce\v_13_2\BasicServices\DataSourcePlanUtils_SSP\RecipientsInfo
     */
     ...
     * @return boolean
     */
    public function getM_SortByPrimaryField()
    {
      return $this->m_SortByPrimaryField;
    }
     ...
     * @return \XMPieWsdlClient\XMPie\uProduce\v_13_2\BasicServices\DataSourcePlanUtils_SSP\RecipientsInfo
     */
    public function setM_SortByPrimaryField($m_SortByPrimaryField)
    {
      $this->m_SortByPrimaryField = $m_SortByPrimaryField;
      return $this;
    }
