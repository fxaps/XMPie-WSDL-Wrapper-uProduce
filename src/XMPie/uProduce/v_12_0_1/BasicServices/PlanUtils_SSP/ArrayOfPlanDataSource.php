...
class ArrayOfPlanDataSource implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @return \XMPieWsdlClient\XMPie\uProduce\v_12_0_1\BasicServices\PlanUtils_SSP\ArrayOfPlanDataSource
     */
     ...
     * @return PlanDataSource
     */
    public function offsetGet($offset): PlanDataSource
    {
     ...
     */
    public function current(): PlanDataSource
    {
