...
class ArrayOfEmailBodyOptions implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @return \XMPieWsdlClient\XMPie\uProduce\v_12_0_1\OtherServices\InteractiveCampaign_SSP\ArrayOfEmailBodyOptions
     */
     ...
     * @return EmailBodyOptions
     */
    public function offsetGet($offset): EmailBodyOptions
    {
     ...
     */
    public function current(): EmailBodyOptions
    {
