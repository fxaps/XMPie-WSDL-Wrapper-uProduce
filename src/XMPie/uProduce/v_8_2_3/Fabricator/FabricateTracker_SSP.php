...
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\AddEvent;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\XMPDateTime;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\ArrayOfProperty;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\Property;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\AddEventResponse;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\AddEventByRun;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\AddEventByRunResponse;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\AddEventType;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\AddEventTypeResponse;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\Delete;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\DeleteResponse;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\AddEventForRecipients;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\ArrayOfString;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\AddEventForRecipientsResponse;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\AddEvents;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\ArrayOfTrackEvent;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\TrackEvent;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\AddEventsResponse;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\CreateNewJob;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\CreateNewJobResponse;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\SetCloudTrackingConfiguration;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\SetCloudTrackingConfigurationResponse;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\GetCloudTrackingConfiguration;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\GetCloudTrackingConfigurationResponse;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\GetCloudTrackingInfo;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\GetCloudTrackingInfoResponse;
use XMPieWsdlClient\XMPie\uProduce\v_8_2_3\OtherServices\Tracker_SSP\CloudTrackingInfo;
...
class FabricateTracker_SSP
{
     ...
     */
    public function AddEventByRun($paramAutoSet = [])
    {
        $paramAutoSet = array_merge($this->paramAutoSet, $paramAutoSet);
        $AddEventByRun = new AddEventByRun();
        foreach ($paramAutoSet as $paramKey => $paramValue) {
            $methodName = 'set' . $paramKey;
            if (method_exists($AddEventByRun, $methodName)) {
                $AddEventByRun->$methodName($paramValue);
            }
        }
        return $AddEventByRun;
    }
     ...
     */
    public function AddEventByRunResponse($paramAutoSet = [])
    {
        $paramAutoSet = array_merge($this->paramAutoSet, $paramAutoSet);
        $AddEventByRunResponse = new AddEventByRunResponse();
        foreach ($paramAutoSet as $paramKey => $paramValue) {
            $methodName = 'set' . $paramKey;
            if (method_exists($AddEventByRunResponse, $methodName)) {
                $AddEventByRunResponse->$methodName($paramValue);
            }
        }
        return $AddEventByRunResponse;
    }
